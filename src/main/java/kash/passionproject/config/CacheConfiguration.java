package kash.passionproject.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, kash.passionproject.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, kash.passionproject.repository.UserRepository.USERS_BY_EMAIL_CACHE);
