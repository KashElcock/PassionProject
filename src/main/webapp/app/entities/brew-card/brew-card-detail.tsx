...
import { getEntity } from './brew-card.reducer';

export const BrewCardDetail = () => {
  ...
  return (
    <Row>
      <Col md="8">
        ...
        <Button tag={Link} to="/brew-card" replace color="info" data-cy="entityDetailsBackButton">
          <FontAwesomeIcon icon="arrow-left" /> <span className="d-none d-md-inline">Back</span>
        </Button>
        &nbsp;
        <Button tag={Link} to={`/brew-card/${brewCardEntity.id}/edit`} replace color="primary">
