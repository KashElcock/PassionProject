...
import { getEntity, deleteEntity } from './brew-card.reducer';

export const BrewCardDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(brewCardEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="passionprojectApp.brewCard.delete.question">Are you sure you want to delete Brew Card {brewCardEntity.id}?</ModalBody>
      <ModalFooter>
...
export default BrewCardDeleteDialog;
