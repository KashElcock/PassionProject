...
export const partialUpdateEntity = createAsyncThunk(
  'brewCard/partial_update_entity',
  async (entity: IBrewCard, thunkAPI) => {
...
export const BrewCardSlice = createEntitySlice({
  name: 'brewCard',
  initialState,
...
export const { reset } = BrewCardSlice.actions;

// Reducer
export default BrewCardSlice.reducer;
