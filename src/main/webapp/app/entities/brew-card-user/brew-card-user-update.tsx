...
// import { getEntityUser, updateEntityUser, createEntityUser, reset } from './brew-card-user.reducer';
//
...
//
//     if (isNew) {
//       dispatch(createEntityUser(entity));
//     } else {
//       dispatch(updateEntityUser(entity));
//     }
//   };
//
//   const defaultValues = () =>
