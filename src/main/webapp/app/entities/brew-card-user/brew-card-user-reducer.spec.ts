...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './brew-card.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BREWCARD_LIST actions', async () => {
    ...
    it('dispatches FETCH_BREWCARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BREWCARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BREWCARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BREWCARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BREWCARD actions', async () => {
      const expectedActions = [
        {
